...
#+html: <a href="https://melpa.org/#/ultra-scroll"><img alt="MELPA" src="https://melpa.org/packages/ultra-scroll-badge.svg"/></a>
...
~ultra-scroll~ exercises some rare corner cases of Emacs' redisplay logic, and as a result has revealed and helped fix a number of display bugs.  These bugs lead to behaviors like slightly staccato scrolling in buffers with diverse line heights (e.g. inline images).  If you think you have found a display bug, open an issue to discuss.
  ...
  - As of June, 2025, another [[https://debbugs.gnu.org/cgi/bugreport.cgi?bug=67604][display bug]] related to line-skipping of visual (i.e. word) wrapped lines with inline images at line start has been fixed (for Emacs v31).  This caused additional "hitches" in smooth scrolling in buffers with numerous inline images.
  - Another display bug which leads to scrolling (and general UI) slowdown in some situations with ~make-cursor-line-fully-visible=t~ was also [[../../issues/32][found]] and [[https://debbugs.gnu.org/cgi/bugreport.cgi?bug=78766][fixed]] in June, 2025.  Will be included with Emacs v31.
